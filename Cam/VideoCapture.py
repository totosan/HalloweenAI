...
try:
    ...
    __myDebug__ = False
    print(f'Debugger not attachable')
...
class VideoCapture(object):
    ...
    def __init__(
        ...
        self.analyzer = injectedAnalyzer
        self.Mouse = None
        self.Drawer = []
        ...
        print("")
        print(f'VideoAnalyzer: {injectedAnalyzer}')
    ...
    def downloadVideo(self, videoUrl):
        ...
        os.system("youtube-dl -o video.mp4 -f mp4 " + videoUrl)
        print("Download Complete")
        self.vCapture = cv2.VideoCapture("video.mp4")
        time.sleep(1.0)
